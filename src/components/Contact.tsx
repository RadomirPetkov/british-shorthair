        ...
        <div>
            ...
            <div className='m-auto flex flex-col gap-5 pb-10 justify-center w-3/4'>
                <div className='flex flex-col gap-3 m-auto'>
                    <h3 className=''>Check our Facebook page</h3>
                ...
                <div className='flex flex-col gap-3 m-auto'>
                    <h3 className=''>Our Instagram page</h3>
                ...
                <div className='flex flex-col gap-3 m-auto'>
                    <h3 className=''>Text us on WhatsApp</h3>
                ...
                <div className='flex flex-col gap-3 m-auto'>
                    <h3 className=''>Get in touch with Viber</h3>
                    <div className='flex flex-row m-auto items-center gap-3'>
                ...
                <div className='flex flex-col gap-3 m-auto'>
                    <h3 className=''>Check our content in TikTok</h3>
                ...
                <div className='flex flex-col gap-3 m-auto'>
                    <h3 className=''>Or send us an email at</h3>
                    <div className='flex flex-row m-auto items-center gap-3'>
                        <MdEmail size={42} />
