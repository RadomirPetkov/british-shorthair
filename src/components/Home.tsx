    ...
    return (
        <div className="h-screen">
            ...
            <section className="pb-10">
                ...
                <button className="bg-black p-5 rounded-full w-52 font-bold  shadow-silver shadow-md border-slate-400 border-4 m-2">
                    <Link to={'/about'} className={linkClassName} >About us</Link>
                </button>
                <button className=" bg-black p-5 text-left rounded-full w-52 font-bold  shadow-silver shadow-md border-slate-400 border-4 m-2">
