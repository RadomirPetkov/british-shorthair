        ...
        <div>
            ...
            <div className="">
                <section className=" flex-col w-screen h-screen relative bg-front-image  bg-no-repeat bg-fixed bg-cover bg-center">
                    ...
                    <h1 className="absolute bottom-32 text-4xl m-auto left-0 right-0 font-bold text-slate-400">SilverGlows British Shorthair</h1>
                </section>
                <section className="pb-10">
                    ...
                    <div className='flex flex-col gap-10 my-10'>
                        <img src={cert2} alt="" className='w-3/4 m-auto rounded-xl' onClick={() => setcert2Open(true)!} />
                        <img src={cert1} alt="" className='w-3/4 m-auto rounded-xl' onClick={() => setcert1Open(true)!} />
                    </div>
