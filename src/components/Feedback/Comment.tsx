...
export const Comment = (props: any) => {
    ...
    return (
        <div className='relative mx-3 my-10 shadow-lg shadow-black border-white border-y-2 rounded-3xl bg-silver max-w-3xl sm:m-auto sm:my-10'>
            ...
            <p className='m-auto border-b-2 border-blue-300 p-3 w-fit text-xl'>{t('owner-name')}: {ownerName} </p>
            <p className='m-auto border-b-2 border-blue-300 p-3 w-fit text-xl'>{t('pet-name')}: {petName}</p>
